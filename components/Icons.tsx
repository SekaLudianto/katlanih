...
const Diamond: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M2.7 10.3a2.41 2.41 0 0 0 0 3.41l7.59 7.59a2.41 2.41 0 0 0 3.41 0l7.59-7.59a2.41 2.41 0 0 0 0-3.41L13.41 2.7a2.41 2.41 0 0 0-3.41 0Z"></path>
    </svg>
);

const Game: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M17.5 9.5a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5Z" />
        <path d="M22 14v5.086a2 2 0 0 1-1.172 1.732L18 22l-2.828-1.182A2 2 0 0 1 14 19.086V14h8Z" />
        <path d="M14 14H2v5.086a2 2 0 0 0 1.172 1.732L6 22l2.828-1.182A2 2 0 0 0 10 19.086V14h4Z" />
        <path d="M10 14V4.914a2 2 0 0 0-1.172-1.732L6 2 3.172 3.182A2 2 0 0 0 2 4.914V14h8Z" />
    </svg>
);
