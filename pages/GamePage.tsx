    ...
    return (
        <div className="relative flex flex-col h-screen">
            <main className="w-full max-w-7xl mx-auto p-4 md:p-6 flex-grow flex flex-col min-h-0">
                ...
                <div className="hidden lg:grid grid-cols-2 gap-4 md:gap-6 mb-4 md:mb-6">
                    <RoomStatsDisplay roomStats={props.roomStats} theme={props.theme} t={props.t} />
                    <button
                        onClick={props.onDisconnect}
                ...
                {/* Desktop Layout */}
                <div className="flex-grow hidden lg:grid grid-cols-3 gap-6 min-h-0">
                ...
                <div className="flex-grow block lg:hidden min-h-0 pb-20">
                    {renderContent()}
                </div>
            </main>
